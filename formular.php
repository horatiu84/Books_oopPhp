...
// verificam daca sesiunea este pornita, in caz contrar o pornim
// daca este deja pornita si incercam sa o pornim a inca odata o sa avem eroare
if (session_status() == PHP_SESSION_NONE) {
    session_start();
}
// pentru orice formular, pt a ma asigura ca este executat de pe pagina mea
// fac un token, care il salvez pe sesiune si il trimit catre formular( var $hash)
$length = 32;
